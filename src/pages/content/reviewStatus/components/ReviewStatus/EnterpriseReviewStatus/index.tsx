...
import styles from './EnterpriseReviewStatus.module.scss';
import cssText from './EnterpriseReviewStatus.module.scss?inline';
...
const EnterpriseReviewStatus = ({ pageName, status, label }: Props) => {
...
export default EnterpriseReviewStatus;
